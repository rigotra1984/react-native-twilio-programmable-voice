...
//    }
    ...
    public Notification getHangupLocalNotification(ReactApplicationContext context, String callSid, String caller, String progressText, String progressAction) {
        PendingIntent pendingHangupIntent = PendingIntent.getBroadcast(
                context,
                0,
                new Intent(ACTION_HANGUP_CALL).putExtra(INCOMING_CALL_NOTIFICATION_ID, HANGUP_NOTIFICATION_ID),
        ...
        notification.addAction(0, progressAction != null? progressAction: "HANG UP", pendingHangupIntent);
